                                ...
                                child: Row(
                                  children: [
                                    ElevatedButton(onPressed: (){print(document['pdf url1']);setState(() {
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFView(document['pdf url1'])));
                                    });}, child: Icon(Icons.download_rounded)),
                                    ElevatedButton(onPressed: (){print(document['pdf url2']);setState(() {
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFView(document['pdf url2'])));
                                    });}, child: Icon(Icons.download_rounded)),
                                  ],
                                ),
                              )
